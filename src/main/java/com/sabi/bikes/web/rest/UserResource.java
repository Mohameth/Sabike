...
import com.sabi.bikes.service.MailService;
import com.sabi.bikes.service.UserService;
import com.sabi.bikes.service.dto.UserDTO;
import com.sabi.bikes.web.rest.errors.BadRequestAlertException;
import com.sabi.bikes.web.rest.errors.EmailAlreadyUsedException;
import com.sabi.bikes.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
     ...
     */
    @PutMapping("/users")
//    @PreAuthorize("hasRole(\"" + AuthoritiesConstants. + "\")")
     ...
     */
    @GetMapping("/users")
    public ResponseEntity<List<UserDTO>> getAllProducts(Pageable pageable) {
