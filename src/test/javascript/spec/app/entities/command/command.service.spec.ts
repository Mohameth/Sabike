...
import { ICommand, Command, OrderState } from 'app/shared/model/command.model';
...
describe('Service Tests', () => {
  describe('Command Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Command(0, OrderState.PENDING, currentDate, 0, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Command', async () => {
        const returnedFromService = Object.assign(
          {
            state: 'BBBBBB',
            orderDate: currentDate.format(DATE_FORMAT),
