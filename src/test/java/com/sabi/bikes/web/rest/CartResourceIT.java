...
import com.sabi.bikes.repository.CartRepository;
...
public class CartResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_EXPIRE_ON = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_EXPIRE_ON = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    private static final ZonedDateTime SMALLER_EXPIRE_ON = ZonedDateTime.ofInstant(Instant.ofEpochMilli(-1L), ZoneOffset.UTC);
    ...
    public void createCart() throws Exception {
        ...
        assertThat(testCart.getExpireOn()).isEqualTo(DEFAULT_EXPIRE_ON);
    }
    ...
    public void getAllCarts() throws Exception {
        ...
        restCartMockMvc.perform(get("/api/carts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].expireOn").value(hasItem(sameInstant(DEFAULT_EXPIRE_ON))));
    }
    ...
    public void getCart() throws Exception {
        ...
        restCartMockMvc.perform(get("/api/carts/{id}", cart.getId()))
            ...
            .andExpect(jsonPath("$.expireOn").value(sameInstant(DEFAULT_EXPIRE_ON)));
    }
    ...
    public void updateCart() throws Exception {
        ...
        Cart testCart = cartList.get(cartList.size() - 1);
        assertThat(testCart.getExpireOn()).isEqualTo(UPDATED_EXPIRE_ON);
    }
